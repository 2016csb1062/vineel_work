...
pivotNode = nodesLabels.index(min(nodesLabels))
...
if(len(GroupA) > 0.9*n or len(GroupB) > 0.9*n):
	...
	print ""
	print "A set consisting of atleast 90% of nodes will have atleast "+str(expDelta)+"% of positive edges. "
...
#------------------------------------------------------------------------#
	...
	print "According To Apprx Balance Theorem : "
	print ""
	print "There are two sets A and B such that :"
	print ""
